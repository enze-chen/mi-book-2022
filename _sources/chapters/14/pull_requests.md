...
_In a different tab_, navigate to this page of the textbook: {doc}`../15/final_presentations`.
On that page, hover over Octocat and click {guilabel}`✏ suggest edit`.

```{image} ../../assets/fig/12/suggest_edit.png
:alt: suggest_edit
:align: center
:width: 100%
```
...
```{image} ../../assets/fig/12/github_fork.png
:alt: github_fork
:align: center
:width: 80%
```
...
```{image} ../../assets/fig/12/github_edits.png
:alt: github_edits
:align: center
:width: 100%
```
...
```{image} ../../assets/fig/12/github_propose.png
:alt: github_propose
:align: center
:width: 100%
```
...
```{image} ../../assets/fig/12/github_compare.png
:alt: github_compare
:align: center
:width: 100%
```
...
````{margin}
```{image} ../../assets/fig/12/github_forked.png
:alt: github_forked
:align: center
:width: 75%
```
...
````{margin}
```{image} ../../assets/fig/12/github_branch.png
:alt: github_branch
:align: center
:width: 90%
```
...
Next, navigate by clicking on the folders to `assets/fig/14` where you should only see `temp.svg`, `temp.png`, and maybe a few other figures, depending on how quickly Enze has merged other students' PRs.
...
```{image} ../../assets/fig/12/github_compare2.png
:alt: github_compare2
:align: center
:width: 100%
```
...
```{image} ../../assets/fig/12/github_open_pr.png
:alt: github_open_pr
:align: center
:width: 95%
```
